#Pipeline modified from (diffusers/pipelines/deepfloyd_if/pipeline_if.py) of Huggingface diffusers 0.27.2 
...
class IFPipeline(DiffusionPipeline, LoraLoaderMixin):
    ...
    def sup_res(
        ...
        A_funcs = get_Afuncs(degrad = 'sr_bicubic',sizes = 64,sr_scale = sr_scale)
